...
def nearest_feature_attr_value(vlayer_id, attr_name, feature, parent):
    """
    Find nearest feature from vector layer and return its attribute value.
    ...
    <div class=\"arguments\">
        <table>
            <tr><td class=\"argument\">vlayer_id</td><td>linestring vector layer id  - get it from Map Layers variables group</td></tr>
...
def nearest_pt_on_line_interpolate_z(vlayer_id, feature, parent):
    """
    Find nearest feature from a linestring vector layer and interpolate z value at point closest to current geometry.
...
def intersecting_features_attr_average(vlayer_id, attr_name, only_center, feature, parent):
    """
    Find feature(s) intersecting current feature (raster cell for Serval) and calculate arithmetic average of their attribute values.
    ...
    <div class=\"arguments\">
        <table>
            <tr><td class=\"argument\">vlayer_id</td><td>a vector layer id  - get it from Map Layers variables group.</td></tr>
            <tr><td class=\"argument\">attr_name</td><td>name of attribute with the value to get.</td></tr>
...
@qgsfunction(args='auto', group='Serval', usesgeometry=True)
def interpolate_from_mesh(mlayer_id, group, dataset, feature, parent):
    """
    ...
    <div class=\"arguments\">
        <table>
            <tr><td class=\"argument\">mlayer_id</td><td>a mesh layer id  - get it from Map Layers variables group.</td></tr>
    ...
    <h4>Examples</h4>
        <div class=\"examples\"><ul>
            <li>
                <code>interpolate_from_mesh( 'mesh_1e2812c5_a34d_1234_81e1_64fd10af7acd', 0, 0 )</code>
                &rarr;
                <code>123.45</code>
            </li>
        </ul></div>
    """
    plugin = plugins["Serval"]
    return plugin.interpolate_from_mesh(feature, mlayer_id, group, dataset)
